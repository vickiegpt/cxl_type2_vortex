...
alias dev_com {
  ...
  if [ check_precomp_device $PRECOMP_DEVICE_LIB_FILE $FORCE_MODELSIM_AE_SELECTION ] {
    eval  qrun -compile -noautoorder -parallel -outdir ./libraries -vlog.options $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS -end \
     ...
     -makelib tennm_hssi_ver "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms.sv" -end \
     -makelib tennm_hssi_ver "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms_ncrypt.sv"  -suppress 13314,2583 -end \
     -makelib tennm_fm_hps_ver "$DEVICES_SIM_LIB_DIR/tennm_fm_hps.sv" -end \
     -makelib tennm_fm_hps_ver "$DEVICES_SIM_LIB_DIR/tennm_fm_hps_ncrypt.sv" -end \
     -makelib tennm_hssi_f1_ver "$QUARTUS_SIM_LIB_DIR/ctfb_hssi_atoms.sv" -end \
     -makelib tennm_hssi_f1_ver "$QUARTUS_SIM_LIB_DIR/ctfb_hssi_atoms_ncrypt.sv"  -suppress 7070,2244,2388,12003,13314,2248,2583,2635,2600 -end \
     -makelib tennm_hssi_f1_ver "$QUARTUS_SIM_LIB_DIR/ctfb_hssi_atoms2_ncrypt.sv"  -suppress 7070,2244,2388,12003,13314,2248,2583,2635,2600 -end \
     -makelib tennm_hssi_r1_ver "$QUARTUS_SIM_LIB_DIR/ctr_hssi_atoms.sv" -end \
     -makelib tennm_hssi_r1_ver "$QUARTUS_SIM_LIB_DIR/ctr_hssi_atoms_ncrypt.sv" -end \
     -makelib tennm_hssi_r1_ver "$QUARTUS_SIM_LIB_DIR/ctrb_hssi_atoms_ncrypt.sv"  -suppress 12003,2388,2244,2902,7033,13276,13388,7061 +define+rnrb_one_lib_IALUP_IP_FLEXBUS_LOGPHY_CXP_EXCLUDE_S_E +define+rnrb_one_lib_CXP_EXCLUDE_E +define+rnrb_one_lib_CXP_EXCLUDE_S_E +define+rnrb_one_lib_CXP_EXCLUDE_S_E_F -end \
...
alias com {
  ...
  set common_design_files [dict values [intel_rtile_cxl_top_cxltyp2_ed::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [intel_rtile_cxl_top_cxltyp2_ed::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
