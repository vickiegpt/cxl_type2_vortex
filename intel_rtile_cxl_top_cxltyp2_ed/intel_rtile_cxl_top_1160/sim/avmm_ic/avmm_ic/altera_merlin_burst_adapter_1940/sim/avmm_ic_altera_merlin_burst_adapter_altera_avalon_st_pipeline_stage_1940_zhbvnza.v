// avmm_ic_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_zhbvnza.v

// Generated using ACDS version 25.1 129

`timescale 1 ps / 1 ps
module avmm_ic_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_zhbvnza #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 107,
		...
		input  wire [106:0] in_data,           //          .data,          Input Data port of Avalon Streaming Sink Interface
		input  wire [7:0]   in_channel,        //          .channel,       Channel input port of Avalon Streaming Sink Interface
		...
		output wire [106:0] out_data,          //          .data,          Output Data port of Avalon Streaming Source Interface
		output wire [7:0]   out_channel        //          .channel,       Channel output port of Avalon Streaming Source Interface
	);

	avmm_ic_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),           //   input,  width = 107,          .data
		...
		.out_data          (out_data),          //  output,  width = 107,          .data
