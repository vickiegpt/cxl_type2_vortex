...
device_libraries='lpm_ver sgate_ver altera_ver altera_mf_ver tennm_ver tennm_hssi_ver tennm_hssi_f1_ver tennm_hssi_r1_ver lpm sgate altera altera_mf altera_lnsim tennm tennm_hssi tennm_fm_hps '
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -zlib 1 -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms_ncrypt.sv"       -work tennm_hssi       
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                        "$DEVICES_SIM_LIB_DIR/tennm_fm_hps.sv"                  -work tennm_fm_hps     
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                        "$DEVICES_SIM_LIB_DIR/tennm_fm_hps_ncrypt.sv"           -work tennm_fm_hps     
fi
