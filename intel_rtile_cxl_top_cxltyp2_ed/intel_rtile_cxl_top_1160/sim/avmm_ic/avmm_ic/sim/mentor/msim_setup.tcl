...
alias dev_com {
  ...
  if [ check_precomp_device $PRECOMP_DEVICE_LIB_FILE $FORCE_MODELSIM_AE_SELECTION ] {
    eval  qrun -compile -noautoorder -parallel -outdir ./libraries -vlog.options $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS -end \
     ...
     -makelib tennm_hssi "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms_ncrypt.sv"  -suppress 13314,2583 -end \
     -makelib tennm_fm_hps "$DEVICES_SIM_LIB_DIR/tennm_fm_hps.sv" -end \
     -makelib tennm_fm_hps "$DEVICES_SIM_LIB_DIR/tennm_fm_hps_ncrypt.sv" -end \
...
alias com {
  ...
  set common_design_files [dict values [avmm_ic::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [avmm_ic::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
