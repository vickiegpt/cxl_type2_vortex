...
alias com {
  ...
  set common_design_files [dict values [avmm_ic_rst_in::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [avmm_ic_rst_in::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
