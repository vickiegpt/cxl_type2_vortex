...
namespace eval afu_slave {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    set design_files [dict create]
    dict set design_files "afu_slave_altera_avalon_mm_bridge_2010_tex5a4i.v" "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/afu_slave_altera_avalon_mm_bridge_2010_tex5a4i.v"
    ...
    dict set design_files "afu_slave.v"                                      "$QSYS_SIMDIR/afu_slave.v"                                                                         
    return $design_files
  }
