...
namespace eval ccv_afu {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "-makelib altera_avalon_mm_bridge_2010 \"[normalize_path "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/ccv_afu_altera_avalon_mm_bridge_2010_tex5a4i.v"]\"   -end"
    ...
    lappend design_files "-makelib ccv_afu \"[normalize_path "$QSYS_SIMDIR/ccv_afu.v"]\"   -end"                                                                                              
    return $design_files
  }
