...
# ----------------------------------------
# If ccl_ic_rst is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ccl_ic_rst.ccl_ic_rst"
}
...
append ELAB_OPTIONS [subst [ccl_ic_rst::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [ccl_ic_rst::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [ccl_ic_rst::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [ccl_ic_rst::normalize_path "$file"]
  set normalized_dest [ccl_ic_rst::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [ccl_ic_rst::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [ccl_ic_rst::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [ccl_ic_rst::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [ccl_ic_rst::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
