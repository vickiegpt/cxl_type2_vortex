...
namespace eval usr_access_master {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "-makelib altera_avalon_mm_bridge_2010 \"[normalize_path "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/usr_access_master_altera_avalon_mm_bridge_2010_tex5a4i.v"]\"   -end"
    ...
    lappend design_files "-makelib usr_access_master \"[normalize_path "$QSYS_SIMDIR/usr_access_master.v"]\"   -end"                                                                                    
    return $design_files
  }
