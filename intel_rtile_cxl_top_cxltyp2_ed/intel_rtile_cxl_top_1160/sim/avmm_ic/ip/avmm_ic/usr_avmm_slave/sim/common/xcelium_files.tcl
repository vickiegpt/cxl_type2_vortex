...
namespace eval usr_avmm_slave {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "xmvlog -zlib 1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/usr_avmm_slave_altera_avalon_mm_bridge_2010_tex5a4i.v\"  -work altera_avalon_mm_bridge_2010 -cdslib  ./cds_libs/altera_avalon_mm_bridge_2010.cds.lib"
    ...
    lappend design_files "xmvlog -zlib 1 -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"$QSYS_SIMDIR/usr_avmm_slave.v\"  -work usr_avmm_slave"                                                                                                                                      
    return $design_files
  }
