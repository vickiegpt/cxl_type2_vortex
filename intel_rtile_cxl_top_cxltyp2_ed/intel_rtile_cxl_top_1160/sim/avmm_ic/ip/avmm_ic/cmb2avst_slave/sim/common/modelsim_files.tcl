...
namespace eval cmb2avst_slave {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "-makelib altera_avalon_mm_bridge_2010 \"[normalize_path "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/cmb2avst_slave_altera_avalon_mm_bridge_2010_tex5a4i.v"]\"   -end"
    ...
    lappend design_files "-makelib cmb2avst_slave \"[normalize_path "$QSYS_SIMDIR/cmb2avst_slave.v"]\"   -end"                                                                                       
    return $design_files
  }
