...
namespace eval ccl_mirror_master {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    set design_files [dict create]
    dict set design_files "ccl_mirror_master_altera_avalon_mm_bridge_2010_tex5a4i.v" "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/ccl_mirror_master_altera_avalon_mm_bridge_2010_tex5a4i.v"
    ...
    dict set design_files "ccl_mirror_master.v"                                      "$QSYS_SIMDIR/ccl_mirror_master.v"                                                                         
    return $design_files
  }
