...
alias com {
  ...
  set common_design_files [dict values [ccl_csb2wire_csr::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [ccl_csb2wire_csr::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
