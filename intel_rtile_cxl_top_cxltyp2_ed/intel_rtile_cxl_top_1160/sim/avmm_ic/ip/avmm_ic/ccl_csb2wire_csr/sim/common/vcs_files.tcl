...
namespace eval ccl_csb2wire_csr {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    set design_files [dict create]
    dict set design_files "ccl_csb2wire_csr_altera_avalon_mm_bridge_2010_tex5a4i.v" "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/ccl_csb2wire_csr_altera_avalon_mm_bridge_2010_tex5a4i.v"
