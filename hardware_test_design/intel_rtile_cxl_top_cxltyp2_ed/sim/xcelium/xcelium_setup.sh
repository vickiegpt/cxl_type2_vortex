...
TOP_LEVEL_NAME="intel_rtile_cxl_top_cxltyp2_ed.intel_rtile_cxl_top_cxltyp2_ed"
QSYS_SIMDIR="./../"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [intel_rtile_cxl_top_cxltyp2_ed::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [intel_rtile_cxl_top_cxltyp2_ed::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [intel_rtile_cxl_top_cxltyp2_ed::get_design_libraries]]
...
device_libraries='lpm_ver sgate_ver altera_ver altera_mf_ver altera_lnsim_ver tennm_ver tennm_hssi_ver tennm_fm_hps_ver tennm_hssi_f1_ver tennm_hssi_r1_ver '
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -zlib 1 -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms.sv"           -work tennm_hssi_ver   
  xmvlog -zlib 1 -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms_ncrypt.sv"    -work tennm_hssi_ver   
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                        "$DEVICES_SIM_LIB_DIR/tennm_fm_hps.sv"               -work tennm_fm_hps_ver 
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                        "$DEVICES_SIM_LIB_DIR/tennm_fm_hps_ncrypt.sv"        -work tennm_fm_hps_ver 
  xmvlog -zlib 1 -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/ctfb_hssi_atoms.sv"            -work tennm_hssi_f1_ver
  xmvlog -zlib 1 -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/ctfb_hssi_atoms_ncrypt.sv"     -work tennm_hssi_f1_ver
  xmvlog -zlib 1 -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/ctfb_hssi_atoms2_ncrypt.sv"    -work tennm_hssi_f1_ver
  xmvlog -zlib 1 -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/ctr_hssi_atoms.sv"             -work tennm_hssi_r1_ver
  xmvlog -zlib 1 -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/ctr_hssi_atoms_ncrypt.sv"      -work tennm_hssi_r1_ver
  xmvlog -zlib 1 -sv +define+rnrb_one_lib_CXL_TOP_OFF $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_SIM_LIB_DIR/ctrb_hssi_atoms_ncrypt.sv"     -work tennm_hssi_r1_ver
fi
...
ELAB_OPTIONS="$ELAB_OPTIONS -genhier"
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [intel_rtile_cxl_top_cxltyp2_ed::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [intel_rtile_cxl_top_cxltyp2_ed::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
