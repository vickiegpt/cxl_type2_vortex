...
TOP_LEVEL_NAME="avmm_ic.avmm_ic"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/steve/opt/unionfs/alt_25_1/quartus/"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [avmm_ic::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [avmm_ic::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [avmm_ic::get_design_libraries]]
...
device_libraries='lpm_ver sgate_ver altera_ver altera_mf_ver altera_lnsim_ver tennm_ver tennm_hssi_ver tennm_fm_hps_ver tennm_hssi_f1_ver tennm_hssi_r1_ver lpm sgate altera altera_mf altera_lnsim tennm tennm_hssi tennm_fm_hps '
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms.sv"                 -work tennm_hssi_ver   
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms_ncrypt.sv"          -work tennm_hssi_ver   
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$DEVICES_SIM_LIB_DIR/tennm_fm_hps.sv"                     -work tennm_fm_hps_ver 
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$DEVICES_SIM_LIB_DIR/tennm_fm_hps_ncrypt.sv"              -work tennm_fm_hps_ver 
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/ctfb_hssi_atoms.sv"                  -work tennm_hssi_f1_ver
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/ctfb_hssi_atoms_ncrypt.sv"           -work tennm_hssi_f1_ver
  vlogan +v2k -sverilog +define+QUARTUS_ENABLE_DPI_FORCE $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_SIM_LIB_DIR/synopsys/ctfb_hssi_atoms2_ncrypt.sv" -work tennm_hssi_f1_ver
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/ctr_hssi_atoms.sv"                   -work tennm_hssi_r1_ver
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/ctr_hssi_atoms_ncrypt.sv"            -work tennm_hssi_r1_ver
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/ctrb_hssi_atoms_ncrypt.sv"           -work tennm_hssi_r1_ver
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms_ncrypt.sv"          -work tennm_hssi       
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$DEVICES_SIM_LIB_DIR/tennm_fm_hps.sv"                     -work tennm_fm_hps     
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$DEVICES_SIM_LIB_DIR/tennm_fm_hps_ncrypt.sv"              -work tennm_fm_hps     
fi
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [avmm_ic::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [avmm_ic::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
