...
# ACDS 25.1 129 linux 2025.09.15.12:29:04
# ----------------------------------------
...
# ----------------------------------------
# If avmm_ic is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "avmm_ic.avmm_ic"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/steve/opt/unionfs/alt_25_1/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [avmm_ic::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [avmm_ic::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [avmm_ic::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [avmm_ic::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [avmm_ic::normalize_path "$file"]
  set normalized_dest [avmm_ic::normalize_path "$dest_file"]
...
set logical_libraries [list "work" "work_lib" "lpm_ver" "sgate_ver" "altera_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_ver" "tennm_hssi_ver" "tennm_fm_hps_ver" "tennm_hssi_f1_ver" "tennm_hssi_r1_ver" "lpm" "sgate" "altera" "altera_mf" "altera_lnsim" "tennm" "tennm_hssi" "tennm_fm_hps"]
...
set libraries [dict merge $libraries [avmm_ic::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [avmm_ic::get_design_libraries]]
...
alias dev_com {
  ...
  if { $PRECOMP_DEVICE_LIB_FILE eq "" } {
    ...
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                  "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms.sv"              -work tennm_hssi_ver   
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                  "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms_ncrypt.sv"       -work tennm_hssi_ver   
    eval  vlog  -err VCP2675 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                  "$DEVICES_SIM_LIB_DIR/tennm_fm_hps.sv"                  -work tennm_fm_hps_ver 
    eval  vlog  -err VCP2675 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                  "$DEVICES_SIM_LIB_DIR/tennm_fm_hps_ncrypt.sv"           -work tennm_fm_hps_ver 
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                  "$QUARTUS_SIM_LIB_DIR/ctfb_hssi_atoms.sv"               -work tennm_hssi_f1_ver
    eval  vlog  -err VCP2557 W1 -err VCP2675 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_SIM_LIB_DIR/ctfb_hssi_atoms_ncrypt.sv"        -work tennm_hssi_f1_ver
    eval  vlog  -err VCP2557 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                  "$QUARTUS_SIM_LIB_DIR/ctfb_hssi_atoms2_ncrypt.sv"       -work tennm_hssi_f1_ver
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                  "$QUARTUS_SIM_LIB_DIR/ctr_hssi_atoms.sv"                -work tennm_hssi_r1_ver
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                  "$QUARTUS_SIM_LIB_DIR/ctr_hssi_atoms_ncrypt.sv"         -work tennm_hssi_r1_ver
    eval  vlog  -err VCP2557 W1 -err VCP2675 W1 +define+rnrb_one_lib_CXL_TOP_OFF $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_SIM_LIB_DIR/ctrb_hssi_atoms_ncrypt.sv"        -work tennm_hssi_r1_ver
    ...
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                  "$QUARTUS_SIM_LIB_DIR/tennm_hssi_atoms_ncrypt.sv"       -work tennm_hssi       
    eval  vlog  -err VCP2675 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                  "$DEVICES_SIM_LIB_DIR/tennm_fm_hps.sv"                  -work tennm_fm_hps     
    eval  vlog  -err VCP2675 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                  "$DEVICES_SIM_LIB_DIR/tennm_fm_hps_ncrypt.sv"           -work tennm_fm_hps     
  }
...
append ELAB_OPTIONS " -sv_lib work -sv_lib $QUARTUS_INSTALL_DIR/eda/sim_lib/libdb_gdr_fec_riviera"
...
alias com {
  ...
  set design_files [dict merge [avmm_ic::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [avmm_ic::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
