...
namespace eval ccl_csb2wire_csr {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "-makelib altera_avalon_mm_bridge_2010 \"[normalize_path "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/ccl_csb2wire_csr_altera_avalon_mm_bridge_2010_tex5a4i.v"]\"   -end"
    ...
    lappend design_files "-makelib ccl_csb2wire_csr \"[normalize_path "$QSYS_SIMDIR/ccl_csb2wire_csr.v"]\"   -end"                                                                                     
    return $design_files
  }
