...
namespace eval ccv_afu {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    set design_files [dict create]
    dict set design_files "ccv_afu_altera_avalon_mm_bridge_2010_tex5a4i.v" "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/ccv_afu_altera_avalon_mm_bridge_2010_tex5a4i.v"
    ...
    dict set design_files "ccv_afu.v"                                      "$QSYS_SIMDIR/ccv_afu.v"                                                                         
    return $design_files
  }
