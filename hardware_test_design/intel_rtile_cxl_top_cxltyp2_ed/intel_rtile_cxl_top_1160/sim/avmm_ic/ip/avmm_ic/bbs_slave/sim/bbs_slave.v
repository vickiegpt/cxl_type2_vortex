...
module bbs_slave #(
		...
		input  wire [7:0]                  s0_byteenable,    //      .byteenable,    Indicates valid read/write data location
		...
		output wire [7:0]                  m0_byteenable,    //      .byteenable,    Indicates valid read/write data location
		output wire                        m0_debugaccess    //      .debugaccess
	);

	bbs_slave_altera_avalon_mm_bridge_2010_tex5a4i #(
