...
namespace eval ccl_mirror_master {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "-makelib altera_avalon_mm_bridge_2010 \"[normalize_path "$QSYS_SIMDIR/../altera_avalon_mm_bridge_2010/sim/ccl_mirror_master_altera_avalon_mm_bridge_2010_tex5a4i.v"]\"   -end"
    ...
    lappend design_files "-makelib ccl_mirror_master \"[normalize_path "$QSYS_SIMDIR/ccl_mirror_master.v"]\"   -end"                                                                                    
    return $design_files
  }
