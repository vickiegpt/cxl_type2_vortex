...
namespace eval emif {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    set design_files [dict create]
    dict set design_files "emif_altera_emif_arch_fm_191_gs4kwha_top.sv" "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif_altera_emif_arch_fm_191_gs4kwha_top.sv"
    ...
    dict set design_files "emif_altera_emif_arch_fm_191_gs4kwha.sv"     "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif_altera_emif_arch_fm_191_gs4kwha.sv"    
    dict set design_files "emif_altera_emif_fm_277_ybkgfay.v"           "$QSYS_SIMDIR/../altera_emif_fm_277/sim/emif_altera_emif_fm_277_ybkgfay.v"               
