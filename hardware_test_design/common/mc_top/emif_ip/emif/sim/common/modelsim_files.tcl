...
namespace eval emif {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "-makelib altera_emif_arch_fm_191 \"[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif_altera_emif_arch_fm_191_gs4kwha_top.sv"]\"   -end"
    ...
    lappend design_files "-makelib altera_emif_arch_fm_191 \"[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif_altera_emif_arch_fm_191_gs4kwha.sv"]\"   -end"    
    lappend design_files "-makelib altera_emif_fm_277 \"[normalize_path "$QSYS_SIMDIR/../altera_emif_fm_277/sim/emif_altera_emif_fm_277_ybkgfay.v"]\"   -end"                    
