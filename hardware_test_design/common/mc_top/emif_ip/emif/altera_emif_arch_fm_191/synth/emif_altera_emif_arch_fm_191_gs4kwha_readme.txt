...
---------------------
 ...
 12. PLL reference clock output
 13. PLL locked signal
 14. On-Chip Termination (OCT) interface
 15. Interface between FPGA and external memory
 16. PHY calibration status interface
 17. User clock domain reset interface
 18. User clock interface
 19. Controller Avalon Memory-Mapped interface 0
 20. EMIF calibration component interface
 21. EMIF calibration component clock input interface
 22. Instantiating IP in a simulation project
 23. Full-calibration versus skip-calibration simulation
 24. IP Settings
...
------------------------
   ...
   This is the readme file for the Intel External Memory Interface (EMIF) IP v25.1.
...
----------------------
   ...
   --------------------------------------------
      ...
      Address/command pinout scheme  : DDR4 Scheme 2: Component and DIMM
...
-----------------------------------
   ...
   Port                           Width   Direction   Description                                        
   ------------------------------------------------------------------------------------------------------
   pll_ref_clk_out                1       output      PLL reference clock output
...
--------------------
   ...
   SYS_INFO_DEVICE                                   : AGIB023R18A1E1V
   ...
   SYS_INFO_UNIQUE_ID                                : emif_emif
   PREV_PROTOCOL_ENUM                                : PROTOCOL_DDR4
   PHY_FPGA_SPEEDGRADE_GUI                           : E1V (ES3) - change device under 'View'->'Device Family'
   PHY_TARGET_SPEEDGRADE                             : E1V
   ...
   PHY_MEM_CLK_FREQ_MHZ                              : 1333.2
   PHY_REF_CLK_FREQ_MHZ                              : 33.33
   ...
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_5                   : 1333.2
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_5                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_6                   : 1333.2
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_6                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_7                   : 1333.2
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_7                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_8                   : 1333.2
   ...
   PHY_DDR4_MEM_CLK_FREQ_MHZ                         : 1333.2
   PHY_DDR4_DEFAULT_REF_CLK_FREQ                     : false
   PHY_DDR4_USER_REF_CLK_FREQ_MHZ                    : 33.33
   ...
   PHY_DDR4_REF_CLK_FREQ_MHZ                         : 33.33
   ...
   PHY_DDR4_USER_AC_DEEMPHASIS_ENUM                  : DEEMPHASIS_MODE_OFF
   ...
   PHY_DDR4_USER_CK_DEEMPHASIS_ENUM                  : DEEMPHASIS_MODE_OFF
   ...
   PHY_DDR4_USER_DATA_OUT_DEEMPHASIS_ENUM            : DEEMPHASIS_MODE_HIGH
   ...
   MEM_DDR4_ALERT_N_PLACEMENT_ENUM                   : DDR4_ALERT_N_PLACEMENT_FM_LANE2
   ...
   MEM_DDR4_TINIT_CK                                 : 666600
   MEM_DDR4_TDQSCK_DERV_PS                           : 2
   MEM_DDR4_TDQSCKDS                                 : 450
   MEM_DDR4_TDQSCKDM                                 : 900
   MEM_DDR4_TDQSCKDL                                 : 1200
   MEM_DDR4_TRAS_CYC                                 : 43
   MEM_DDR4_TRCD_CYC                                 : 19
   MEM_DDR4_TRP_CYC                                  : 19
   MEM_DDR4_TRFC_CYC                                 : 467
   MEM_DDR4_TWR_CYC                                  : 20
   MEM_DDR4_TRTP_CYC                                 : 10
   MEM_DDR4_TFAW_CYC                                 : 28
   MEM_DDR4_TREFI_CYC                                : 10399
   MEM_DDR4_WRITE_CMD_LATENCY                        : 6
   MEM_DDR4_TRFC_DLR_CYC                             : 120
   ...
   DIAG_EXPORT_PLL_REF_CLK_OUT                       : true
