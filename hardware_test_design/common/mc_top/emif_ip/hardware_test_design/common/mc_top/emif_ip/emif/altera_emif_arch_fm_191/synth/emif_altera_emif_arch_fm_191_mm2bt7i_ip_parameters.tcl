...
set ::GLOBAL_emif_altera_emif_arch_fm_191_mm2bt7i_corename emif_altera_emif_arch_fm_191_mm2bt7i
...
set var(tQH)                                                     0.43
set var(tDS)                                                     0.041254125412541254
set var(tDH)                                                     0.041254125412541254
set var(tIS)                                                     0.055
set var(tIH)                                                     0.08
set var(tDQSCK)                                                  0.17
set var(tDQSS)                                                   0.27
...
set var(PHY_MEM_CLK_FREQ_MHZ)                                    1333.2
set var(PHY_REF_CLK_FREQ_MHZ)                                    33.33
set var(PHY_REF_CLK_JITTER_PS)                                   10.0
set var(PLL_REF_CLK_FREQ_PS_STR)                                 "30000 ps"
set var(PLL_VCO_FREQ_PS_STR)                                     "750 ps"
