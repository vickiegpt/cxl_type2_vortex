//altecc_decoder CBX_AUTO_BLACKBOX="ALL" CBX_SINGLE_OUTPUT_FILE="ON" device_family="Agilex 7" lpm_pipeline=2 width_codeword=72 width_dataword=64 clock data err_corrected err_detected err_fatal q syn_e
//VERSION_BEGIN 25.1 cbx_altecc_decoder 2025:03:20:21:34:13:SC cbx_lpm_add_sub 2025:03:20:21:34:13:SC cbx_lpm_compare 2025:03:20:21:34:13:SC cbx_lpm_decode 2025:03:20:21:34:13:SC cbx_mgl 2025:03:20:21:34:15:SC cbx_nadder 2025:03:20:21:34:13:SC cbx_stratix 2025:03:20:21:34:13:SC cbx_stratixii 2025:03:20:21:34:13:SC  VERSION_END
...
//synthesis_resources = lpm_decode 1 mux21 64 reg 140 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altecc_dec_latency2_altecc_1917_wmmfpqy
	( 
	clock,
	data,
	err_corrected,
	...
	err_fatal,
	q,
	syn_e) /* synthesis synthesis_clearbox=1 */;
	input   clock;
	input   [71:0]  data;
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) dffe1a <= 72'b0;
		else if  (clocken == 1'b1)   dffe1a <= data;
	// synopsys translate_off
	initial
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) syn_e_pipeline0c <= 1'b0;
		else if  (clocken == 1'b1)   syn_e_pipeline0c <= syn_e_wire;
 ...
 parity_final_wire[20]), (data_wire[20] ^ parity_final_wire[19]), (data_wire[19] ^ parity_final_wire[18]), (data_wire[18] ^ parity_final_wire[17]), (data_wire[17] ^ parity_final_wire[16]), (data_wire[16] ^ parity_final_wire[15]), (data_wire[15] ^ parity_final_wire[14]), (data_wire[14] ^ parity_final_wire[13]), (data_wire[13] ^ parity_final_wire[12]), (data_wire[12] ^ parity_final_wire[11]), (data_wire[11] ^ parity_final_wire[10]), (data_wire[10] ^ parity_final_wire[9]), (data_wire[9] ^ parity_final_wire[8]), (data_wire[8] ^ parity_final_wire[7]), (data_wire[7] ^ parity_final_wire[6]), (data_wire[6] ^ parity_final_wire[5]), (data_wire[5] ^ parity_final_wire[4]), (data_wire[4] ^ parity_final_wire[3]), (data_wire[3] ^ parity_final_wire[2]), (data_wire[2] ^ parity_final_wire[1]), (data_wire[1] ^ parity_final_wire[0]), (data_wire[71] ^ data_wire[0])},
		...
		syn_bit = syn_t[5],
		syn_e = syn_e_pipeline0c,
		syn_e_int = syndrome[7],
		syn_e_wire = syn_e_int,
...
endmodule //altecc_dec_latency2_altecc_1917_wmmfpqy
//VALID FILE
