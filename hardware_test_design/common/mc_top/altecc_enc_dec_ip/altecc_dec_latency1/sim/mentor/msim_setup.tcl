...
alias com {
  ...
  set common_design_files [dict values [altecc_dec_latency1::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [altecc_dec_latency1::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
