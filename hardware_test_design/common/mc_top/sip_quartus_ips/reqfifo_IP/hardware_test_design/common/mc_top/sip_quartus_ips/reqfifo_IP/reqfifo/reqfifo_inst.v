	reqfifo u0 (
		.data    (_connected_to_data_),    //   input,  width = 675,  fifo_input.datain
		...
		.q       (_connected_to_q_),       //  output,  width = 675, fifo_output.dataout
		...
		.wrempty (_connected_to_wrempty_)  //  output,    width = 1,            .wrempty
	);
