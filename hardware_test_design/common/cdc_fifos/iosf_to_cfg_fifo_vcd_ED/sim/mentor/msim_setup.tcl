...
alias com {
  ...
  set common_design_files [dict values [iosf_to_cfg_fifo_vcd_ED::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [iosf_to_cfg_fifo_vcd_ED::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
