...
alias com {
  ...
  set common_design_files [dict values [fifo_12b_256w_show_ahead::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [fifo_12b_256w_show_ahead::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
