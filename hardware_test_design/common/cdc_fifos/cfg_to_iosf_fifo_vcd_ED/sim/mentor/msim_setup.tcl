...
alias com {
  ...
  set common_design_files [dict values [cfg_to_iosf_fifo_vcd_ED::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [cfg_to_iosf_fifo_vcd_ED::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
